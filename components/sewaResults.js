...
const SewaResults = () => {
    ...
    useEffect(() => {
        async function getResultPoints() {
            ...
            const res = await results.getPointResults(userid, authpassword, power, countryId, stateId, distId, blockId, gender);
            if (res.success) {
    ...
    return (
        <div className="result-container">
            ...
            <table>
                ...
                {stateResult && stateResult.map(state => (<tr onClick={() => openStateResult(state)}>
