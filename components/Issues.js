            ...
            <div className="issues-container">
                {
                    issuesList && issuesList.map((detail, index) => {
                        ...
                        console.log(issuedes.length,'length')
                            return (
                                <div id={`profile${index}`} class="profile" style={{height: issuedes.length < 100 ? 140 : issuedes.length < 200 ? 180 :issuedes.length < 250 ? 250:300}}>
                                    <div >
